...
var paths = {
  ...
  vendor:     ['./www/lib/ionic/js/ionic.bundle.js',
                ...
                './www/lib/mixpanel/mixpanel-jslib-snippet.js',
                './www/lib/angular-spinners/dist/angular-spinners.js'
...
gulp.task('delete-files', function() {
  ...
  if (process.env.CORDOVA_CMDLINE && process.env.CORDOVA_CMDLINE.indexOf('--production') > 0) {
    ...
    del([
      ...
      'platforms/android/assets/www/lib/mixpanel/**',
      '!platforms/android/assets/www/lib/mixpanel',
      '!platforms/android/assets/www/lib/mixpanel/mixpanel.min.js',
